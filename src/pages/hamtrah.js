...
export default function Home() {
  return (
      <div className="dark:bg-neutral-950 bg-white flex flex-col items-center justify-center">
            {/* Zuragtai heseg */}
                ...
                <div className="bg-black  opacity-75 w-full h-full ">
                    <div className="flex w-full p-12 py-10 gap-36 justify-around items-center z-50">
                        ...
                        <div className="gap-8 text-white text-sm font-bold items-center hidden lg:flex">
                            <a onClick={() => router.push('/index')} className="hover:text-lime-700 transition-all " href="">ЭХЛЭЛ</a>
            ...
            <div className="flex flex-col gap-96 px-12 md:flex-row text-white mt-[50px] text-sm max-w-[960px] lg:max-w-[1200px]">
                <div className="">
                    ...
                    <p className="top-[30px] relative leading-8 text-sm">Дараах үйлчилгээгээр хамтран ажиллах боломжтой бөгөөд <br /> хамтран ажиллах хүсэлт илгээх хэсэгт саналаа илгээнэ үү.</p>
                    <p className="relative top-[60px] leading-8 text-[15px] font-light text-zinc-400">• Зар сурталчилгааны үнийн санал<br />
                ...
                <div className="">
                    ...
                    <p className="top-[30px] relative leading-8 text-sm">Дараах нэвтрүүлгүүдээр бизнесийн байгууллага, хамт олонтой <br /> хамтран ажиллах боломжтой.</p>
                    <p className="relative top-[60px] leading-8 text-[15px] font-light text-zinc-400">• Шоу нэвтрүүлгүүд:<br />
            ...
            <div className="w-full flex-col flex items-center relative left-[6%]">
                <div className="flex flex-col text-white gap-[23px] mt-[60px] w-5/6 lg:min-w-[960px]">
                    <p>Таны нэр</p>
                    ...
                    <button type="submit" class="bg-lime-700 mt-8 w-36 h-12 rounded">Илгээх</button>
                </div>
            </div>
            {/* Footer */}
